 ...
 */
package org.microservices.order_service.events;
...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1110539869840271773L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"org.microservices.order_service.events\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public static org.microservices.order_service.events.OrderPlacedEvent.Builder newBuilder() {
    return new org.microservices.order_service.events.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static org.microservices.order_service.events.OrderPlacedEvent.Builder newBuilder(org.microservices.order_service.events.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new org.microservices.order_service.events.OrderPlacedEvent.Builder();
    } else {
      return new org.microservices.order_service.events.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static org.microservices.order_service.events.OrderPlacedEvent.Builder newBuilder(org.microservices.order_service.events.OrderPlacedEvent other) {
    if (other == null) {
      return new org.microservices.order_service.events.OrderPlacedEvent.Builder();
    } else {
      return new org.microservices.order_service.events.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.microservices.order_service.events.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.microservices.order_service.events.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.microservices.order_service.events.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.microservices.order_service.events.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.microservices.order_service.events.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.microservices.order_service.events.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.microservices.order_service.events.OrderPlacedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.microservices.order_service.events.OrderPlacedEvent.Builder clearName() {
      name = null;
